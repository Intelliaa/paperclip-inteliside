/**
 * PluginEventBus — typed in-process event bus for the TaskOrg plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@taskorg/shared";
import type { PluginEvent, EventFilter } from "@taskorg/plugin-sdk";
