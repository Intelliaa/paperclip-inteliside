 ...
 */
import type { CompanyPortabilityManifest } from "@taskorg/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [TaskOrg](https://taskorg.ing)");
  lines.push("");
