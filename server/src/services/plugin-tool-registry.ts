...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@taskorg/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: TaskOrgPluginManifestV1, pluginDbId?: string): void;
