...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: TaskOrgPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a TaskOrg object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
