...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local TaskOrg state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".taskorg/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/taskorg",
      ),
    ).toBe(false);
