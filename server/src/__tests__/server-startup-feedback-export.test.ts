...
vi.mock("../config.js", () => ({
  loadConfig: vi.fn(() => ({
    ...
    databaseUrl: "postgres://taskorg:taskorg@127.0.0.1:5432/taskorg",
    embeddedPostgresDataDir: "/tmp/taskorg-test-db",
    embeddedPostgresPort: 54329,
    databaseBackupEnabled: false,
    databaseBackupIntervalMinutes: 60,
    databaseBackupRetentionDays: 30,
    databaseBackupDir: "/tmp/taskorg-test-backups",
    serveUi: false,
    uiDevMiddleware: false,
    secretsProvider: "local_encrypted",
    secretsStrictMode: false,
    secretsMasterKeyFilePath: "/tmp/taskorg-master.key",
    storageProvider: "local_disk",
    storageLocalDiskBaseDir: "/tmp/taskorg-storage",
    storageS3Bucket: "taskorg-test",
