...
import { models as codexFallbackModels } from "@taskorg/adapter-codex-local";
import { models as cursorFallbackModels } from "@taskorg/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@taskorg/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@taskorg/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.TASKORG_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.TASKORG_OPENCODE_COMMAND = "__taskorg_missing_opencode_command__";
