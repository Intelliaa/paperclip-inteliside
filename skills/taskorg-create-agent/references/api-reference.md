# Referencia de la API de Creación de Agentes de TaskOrg
...
- Después de la resolución de la aprobación, el solicitante puede ser despertado con `TASKORG_APPROVAL_ID` y debe reconciliar los issues vinculados.
