...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within TaskOrgPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the TaskOrg host.
 *
...
export interface TaskOrgPluginManifestV1 {
   ...
   */
  minimumTaskOrgVersion?: PluginMinimumHostVersion;
