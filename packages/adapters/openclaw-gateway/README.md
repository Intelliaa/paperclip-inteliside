...
This document describes how `@taskorg/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into TaskOrg logs/transcript parsing
