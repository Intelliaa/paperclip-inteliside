import type { PluginLauncherRegistration } from "@taskorg/plugin-sdk";

export const PLUGIN_ID = "taskorg-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".taskorg-kitchen-sink-demo.txt",
} as const;
