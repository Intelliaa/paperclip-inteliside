...
const manifest: TaskOrgPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current TaskOrg plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "TaskOrg",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the TaskOrg domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
