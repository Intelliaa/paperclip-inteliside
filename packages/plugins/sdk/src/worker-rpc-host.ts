...
import type { TaskOrgPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@taskorg/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: TaskOrgPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@taskorg/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
