 ...
 * channel.
 *
 * The TaskOrg plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@taskorg/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all TaskOrg messages.
 */
...
/**
 * TaskOrg plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this TaskOrg instance. */
    instanceId: string;
    /** Semver version of the running TaskOrg host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
