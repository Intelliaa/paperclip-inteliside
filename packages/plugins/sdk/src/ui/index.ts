/**
 * `@taskorg/plugin-sdk/ui` — TaskOrg plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@taskorg/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@taskorg/plugin-sdk/ui";
 *
