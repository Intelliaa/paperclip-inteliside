/**
 * `definePlugin` — the top-level helper for authoring a TaskOrg plugin.
 *
...
// ---------------------------------------------------------------------------
// TaskOrgPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface TaskOrgPlugin {
 ...
 * @returns A sealed `TaskOrgPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@taskorg/plugin-sdk";
