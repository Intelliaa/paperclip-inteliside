...
import type { PluginCategory, PluginStatus, TaskOrgPluginManifestV1 } from "@taskorg/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<TaskOrgPluginManifestV1>().notNull(),
