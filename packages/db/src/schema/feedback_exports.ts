...
export const feedbackExports = pgTable(
  "feedback_exports",
  {
    ...
    schemaVersion: text("schema_version").notNull().default("taskorg-feedback-envelope-v2"),
    bundleVersion: text("bundle_version").notNull().default("taskorg-feedback-bundle-v2"),
    payloadVersion: text("payload_version").notNull().default("taskorg-feedback-v1"),
