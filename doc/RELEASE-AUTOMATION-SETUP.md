...
This document covers the GitHub and npm setup required for the current TaskOrg release model:
...
Do this for every public package that TaskOrg publishes.
...
3. add a trusted publisher for the GitHub repository `taskorg/taskorg`
...
2. revoke any personal automation token that used to publish TaskOrg
