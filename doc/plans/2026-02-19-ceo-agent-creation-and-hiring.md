...
- installed adapter list for this TaskOrg instance
...
## 8. New Skill: `taskorg-create-agent`

Create new skill directory:

- `skills/taskorg-create-agent/SKILL.md`
...
Also update `skills/taskorg/SKILL.md` to reference this skill for hiring workflows.
...
- `taskorg-create-agent` skill + docs updates
