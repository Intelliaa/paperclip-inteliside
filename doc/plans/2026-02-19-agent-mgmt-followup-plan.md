...
- `skills/taskorg/SKILL.md` and `skills/taskorg/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/taskorg-create-agent/SKILL.md`
