...
This is intentionally separate from the normal TaskOrg dev image.
...
```sh
review-checkout-pr taskorg/taskorg 432
cd /work/checkouts/taskorg-taskorg/pr-432
```
...
## Preview the TaskOrg app from the PR
...
- TaskOrg's embedded PostgreSQL and local storage stay inside the container home volume via `TASKORG_HOME=/home/reviewer/.taskorg-review`.
