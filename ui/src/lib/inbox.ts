import type { Approval, DashboardSummary, HeartbeatRun, Issue, JoinRequest } from "@taskorg/shared";

export const RECENT_ISSUES_LIMIT = 100;
export const FAILED_RUN_STATUSES = new Set(["failed", "timed_out"]);
export const ACTIONABLE_APPROVAL_STATUSES = new Set(["pending", "revision_requested"]);
export const DISMISSED_KEY = "taskorg:inbox:dismissed";
export const READ_ITEMS_KEY = "taskorg:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "taskorg:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "taskorg:inbox:issue-columns";
