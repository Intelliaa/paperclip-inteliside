...
import type { Goal } from "@taskorg/shared";
import { GOAL_STATUSES, GOAL_LEVELS } from "@taskorg/shared";
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        {goal.parentId && (
          <PropertyRow label="Meta superior">
            <Link
      ...
      <div className="space-y-1">
        <PropertyRow label="Creada">
          <span className="text-sm">{formatDate(goal.createdAt)}</span>
        </PropertyRow>
        <PropertyRow label="Actualizada">
