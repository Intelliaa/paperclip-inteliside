...
const DRAFT_KEY = "taskorg:issue-draft";
...
const statuses = [
  ...
  { value: "done", label: "Hecho", color: issueStatusText.done ?? issueStatusTextDefault },
];
...
export function NewIssueDialog() {
  ...
  const createIssue = useMutation({
    ...
    onSuccess: ({ issue, companyId, failures }) => {
      ...
      if (failures.length > 0) {
        ...
        pushToast({
          title: `Creado ${issueRef} con advertencias de subida`,
          body: `${failures.length} ${failures.length === 1 ? "archivo preparado no pudo" : "archivos preparados no pudieron"} ser agregados.`,
          tone: "warn",
          action: prefix
  ...
  const createIssueErrorMessage =
    createIssue.error instanceof Error ? createIssue.error.message : "Error al crear la tarea. Inténtalo de nuevo.";
        ...
        {currentProject && currentProjectSupportsExecutionWorkspace && (
          <div className="px-4 py-3 shrink-0 space-y-2">
            <div className="space-y-1.5">
              <div className="text-xs font-medium">Workspace de ejecución</div>
              <div className="text-[11px] text-muted-foreground">
                Controla si esta tarea se ejecuta en el workspace compartido, uno nuevo aislado o uno existente.
              </div>
              <select
              ...
              {executionWorkspaceMode === "reuse_existing" && (
                ...
                >
                  <option value="">Elegir un workspace existente</option>
              ...
              {executionWorkspaceMode === "reuse_existing" && selectedReusableExecutionWorkspace && (
                <div className="text-[11px] text-muted-foreground">
                  Reutilizando {selectedReusableExecutionWorkspace.name} de {selectedReusableExecutionWorkspace.branchName ?? selectedReusableExecutionWorkspace.cwd ?? "workspace de ejecución existente"}.
                </div>
              )}
            </div>
          </div>
              ...
              <div className="mt-2 rounded-md border border-border p-3 bg-muted/20 space-y-3">
                <div className="space-y-1.5">
                  ...
                  <InlineEntitySelector
                    ...
                    disablePortal
                    noneLabel="Modelo predeterminado"
                ...
                <div className="space-y-1.5">
                  <div className="text-xs text-muted-foreground">Esfuerzo de razonamiento</div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? "Creando..." : "Crear tarea"}</span>
              </span>
            </Button>
          </div>
        </div>
