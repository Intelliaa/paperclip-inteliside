...
import { buildAgentMentionHref, buildProjectMentionHref } from "@taskorg/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative taskorg-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("taskorg-mdxeditor", !bordered && "taskorg-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "taskorg-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
