...
export function NotFoundPage({ scope = "global", requestedPrefix }: NotFoundPageProps) {
  ...
  const title = scope === "invalid_company_prefix" ? "Compañía no encontrada" : "Página no encontrada";
  const description =
    scope === "invalid_company_prefix"
      ? `Ninguna compañía coincide con el prefijo "${normalizedPrefix ?? "desconocido"}".`
      : "Esta ruta no existe.";
