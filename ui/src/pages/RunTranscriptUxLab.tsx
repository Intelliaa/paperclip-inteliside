...
const surfaceOptions: Array<{
...
}> = [
  {
    ...
    eyebrow: "Transcripción completa",
    description: "La página de ejecución completa con el selector `Nice | Raw` y la vista de transcripción más detallada.",
    icon: MonitorCog,
  },
  {
    id: "live",
    label: "Widget de tarea",
    eyebrow: "Transmisión en vivo",
    description: "El widget de ejecución en vivo del detalle de tarea, optimizado para seguir una ejecución activa sin salir de la página.",
    icon: RadioTower,
  },
  {
    id: "dashboard",
    label: "Tarjeta de dashboard",
    eyebrow: "Tarjeta compacta",
    description: "La tarjeta de dashboard de agentes activos, ajustada para una exploración compacta manteniendo el mismo lenguaje de transcripción.",
    icon: PanelsTopLeft,
  },
];
    ...
    <div className="overflow-hidden rounded-xl border border-border/70 bg-background/80 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
      <div className="border-b border-border/60 bg-background/90 px-5 py-4">
        ...
        <div className="mt-2 text-sm font-medium">
          Transcripción ({runTranscriptFixtureEntries.length})
        </div>
      </div>
    ...
    <div className="overflow-hidden rounded-xl border border-cyan-500/25 bg-background/85 shadow-[0_20px_50px_rgba(6,182,212,0.10)]">
      <div className="border-b border-border/60 bg-cyan-500/[0.05] px-5 py-4">
        ...
        <div className="mt-1 text-xs text-muted-foreground">
          Transmisión compacta de transcripción en vivo para la página de detalle de tarea.
        </div>
      </div>
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="mt-2 text-[11px] text-muted-foreground">
                {streaming ? "En vivo ahora" : "Finalizado hace 2m"}
              </div>
            </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
          ...
          <main className="min-w-0 p-5">
            <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <Badge variant="outline" className="rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.18em]">
                  Ejecución fuente {runTranscriptFixtureMeta.sourceRunId.slice(0, 8)}
                </Badge>
                <Badge variant="outline" className="rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.18em]">
            ...
            <div className="mb-5 flex flex-wrap items-center gap-2">
              ...
              >
                {streaming ? "Mostrar estado finalizado" : "Mostrar estado en transmisión"}
              </Button>
            </div>
