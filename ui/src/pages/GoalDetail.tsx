...
import type { Goal, Project } from "@taskorg/shared";
      ...
      <Tabs defaultValue="children">
        <TabsList>
          ...
          <TabsTrigger value="projects">
            Proyectos ({linkedProjects.length})
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="children" className="mt-4 space-y-3">
          ...
          {childGoals.length === 0 ? (
            <p className="text-sm text-muted-foreground">No hay sub-objetivos.</p>
          ) : (
        ...
        <TabsContent value="projects" className="mt-4">
          {linkedProjects.length === 0 ? (
            <p className="text-sm text-muted-foreground">No hay proyectos vinculados.</p>
          ) : (
