...
export function Org() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message="Selecciona una empresa para ver la organización." />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message="No hay agentes en la organización. Crea agentes para construir tu estructura organizacional."
        />
      )}
