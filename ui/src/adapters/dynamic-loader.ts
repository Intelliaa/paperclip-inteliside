 ...
 *
 * When the TaskOrg UI encounters an adapter type that doesn't have a
 ...
 * runtime dependencies, and TaskOrg's UI loads it on demand.
 */

import type { TranscriptEntry } from "@taskorg/adapter-utils";
