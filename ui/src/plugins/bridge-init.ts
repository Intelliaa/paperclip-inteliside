 ...
 *
 * This is placed on `globalThis.__taskorgPluginBridge__` and consumed by
...
declare global {
  ...
  var __taskorgPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__taskorgPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__taskorgPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
