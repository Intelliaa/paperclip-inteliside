...
Eval framework for testing TaskOrg agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the TaskOrg heartbeat skill:
